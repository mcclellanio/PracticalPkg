...
DocMeta.setdocmeta!(PracticalPkg, :DocTestSetup, :(using PracticalPkg); recursive = true)
...
makedocs(;
    modules = [PracticalPkg],
    authors = "mcclellanio mcclellanio@fastmail.com",
    repo = "https://github.com/mcclellanio/PracticalPkg.jl/blob/{commit}{path}#{line}",
    sitename = "PracticalPkg.jl",
    format = Documenter.HTML(; canonical = "https://mcclellanio.github.io/PracticalPkg.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/mcclellanio/PracticalPkg.jl")
